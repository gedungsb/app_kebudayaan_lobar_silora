...
class CoePage extends StatefulWidget {
  // Parameter Navigasi agar tombol kembali berfungsi fleksibel
...
class _CoePageState extends State<CoePage> {
  ...
  void initState() {
    super.initState();
    // Jika tahun sekarang 2026, fokus ke hari ini
  ...
  List<Map<String, dynamic>> _getCombinedAndFilteredEvents(
    ...
    List<Map<String, dynamic>> firebaseEvents = firebaseDocs.map((doc) {
      ...
      return {
        ...
        'kategori': 'EVENT',
        'jenis': data['klasifikasi'] ?? 'EVENT', // Fallback agar tidak null
        'is_new': true, // Penanda data baru dari admin
        'created_at': data['createdAt']
      };
    }).toList();

    // 2. Gabungkan dengan Data Manual
    ...
    // 4. Sorting (Urutkan Berdasarkan Tanggal Event)
    filtered.sort((a, b) {
